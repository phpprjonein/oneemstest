				...
				<div class="col-md-12">
					...
					<div class="panel">
						...
						<div class="form-row align-items-center justify-content-center">
							<div id="ajax_loader">
								<img src="resources/img/ajax-loader.gif"></img>
							</div>
						</div>
						<div class="form-row align-items-center justify-content-center"
							id="ip-mgt-utils" style="display: none;">
							<!-- region selection -->
							<div class="col-sm-12 col-md-auto text-center">
								...
								<div class="btn-group" id="ip-allocation-region">
									<button type="button" class="btn dropdown-toggle"
										...
										aria-expanded="false">SELECT REGION</button>
							...
							<div class="col-sm-12 col-md-auto text-center">
								<div class="form-check mb-2 mb-sm-0">
									<div class="btn-group" role="group" aria-label="">
										...
										<button type="button" class="btn" id="add-a-subnet"
											data-toggle="modal">ADD A SUBNET</button>
									</div>
								</div>
							</div>
							<!-- /add row button -->
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-1">
								<div class="nav flex-column nav-pills" id="v-pills-tab"
									...
									<a class="nav-link active text-center" id="v-pills-home-tab"
										data-toggle="pill" href="#v-pills-home" role="tab"
										aria-controls="v-pills-home" aria-selected="true">IPv4</a> <a
										class="nav-link" id="v-pills-profile-tab" data-toggle="pill"
										href="#v-pills-profile" role="tab"
										aria-controls="v-pills-profile" aria-selected="false"
										style="display: none;">IPv6</a>
								</div>
							</div>
							<!-- /table pill navigation -->
							<!-- region selection -->
							<div class="col-sm-12 col-md-3 text-center">
								...
								<div class="btn-group" id="ip-allocation-region-dt-filter">
									<button type="button" class="btn dropdown-toggle"
										data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">GreatLakes</button>
									<div class="dropdown-menu">
          <?php
        $region_list = get_ipallocation_region_list();
        foreach ($region_list['result'] as $rkey => $rvalue) :
        ...
        // if(count($region_list['result']) > 1): ?>
          ...
          <?php //endif; ?>
							...
							<div class="col">
								<div class="input-group" id="search-v-pills-home">
									<input type="text" class="form-control"
										placeholder="Search IP V4 Table" aria-label="Search Table"> <span
								...
								<div class="input-group" style="display: none;"
									id="search-v-pills-profile">
									<input type="text" class="form-control"
										placeholder="Search IP V6 Table" aria-label="Search Table"> <span
										class="input-group-btn">
										<button class="btn btn-light" type="button">
							...
							<div class="col-md-2 col-xs-6">
								...
								<p class="export" id="export-v-pills-profile"></p>
							</div>
							<!-- /Export table -->
						</div>
						<!-- IP management table row -->
...
$resultset = load_ipv_dataset('ipv4');
            ...
            ?>
									...
									<div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
										...
										<table id="ipmgt-ipv6"
											class="table table-striped table-sm table-responsive ipv6-table">
											<thead class="thead-light">
												<tr>
													<th scope="col">Market</th>
													<th scope="col" style="display: none;">Region</th>
...
$resultset = load_ipv_dataset('ipv6');
	...
	<div class="modal fade" id="exampleModalIPM" tabindex="-1"
		role="dialog" aria-labelledby="exampleModalIPMLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content table-responsive">
				...
				<div class="modal-body">
					<input type="hidden" name="selected_region" id="selected_region"
						value=""> <input type="hidden" name="selected_market"
						id="selected_market" value="">
					<!-- add subnet mask form -->
					<div id="status" style="display: none;" class="alert"></div>
					<div class="alert alert-success" style="display: none;">IP details
								...
								<td>
									<div class="row">
										<div class="col-lg-8 col-md-12 col-sm-12">
											<input type="email" class="form-control" id="inputSubnet"
												placeholder="SUBNET">
										</div>
										...
										<div class="col-lg-3 col-md-12 col-sm-12">
											<input type="email" class="form-control" id="inputMask"
												placeholder="MASK">
										</div>
									</div>
								</td>
