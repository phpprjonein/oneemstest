  $(document).ready(function () {
      ...
      $("#reboot .dt-buttons").append('<a class="dt-button buttons-excel buttons-html5 dtexcelbtn dtexcelbtn-cs" tabindex="0" aria-controls="example"><span></span></a>');
      ...
      $(document).on('click', '.dtexcelbtn-cs', function(event) {
		  ...
		  location.href = "xls-export-process.php?case=reboot&userid=" + $('#userid').val() + "&deviceseries=" + deviceseries +"&listname=" + listname + "&search=" + $('.dataTables_filter input').val() + "&column=" + sortInfo[0][0] + "&dir=" + sortInfo[0][1];
		  return false;
	  });
