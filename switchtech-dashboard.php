				...
				<div class="maprow">
					...
					<div id="map_section" class="sec_with_map border table-responsive" style='<?php echo ($show_map_flag) ? "display: block" : "display: none" ?>;'>
						...
						<map name="United States of America">
							<!-- Pacific Northwest -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Pacific Northwest', $_SESSION['sel_region']))){ ?>
							...
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Northern California/Nevada', $_SESSION['sel_region']))){ ?>
							...
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Pacific Northwest/Alaska', $_SESSION['sel_region']))){ ?>
							...
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Pacific Northwest Hawaii', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- South West  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('South West', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Central Texas  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Central Texas', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Houston/Gulf Coast  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Houston/Gulf Coast', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- South Central  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('South Central', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Florida  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Florida', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Georgia/Alabama  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Georgia/Alabama', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Carolina/Tennessee  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Carolina/Tennessee', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- New York Metro  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('New York Metro', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- New England  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('New England', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- New York  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('New York', $_SESSION['sel_region']))){ ?>
							...
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Washington/Baltimore/Virginia', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Michigan/Indiana/KY  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Michigan/Indiana/KY', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- OPW  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('OPW', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Illinois/Wisconsin  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Illinois/Wisconsin', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Kansas/Missouri  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Kansas/Missouri', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Mountain  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Mountain', $_SESSION['sel_region']))){ ?>
							...
							<?php } ?>
							<!-- Pacific  -->
							<?php if((isset($_SESSION['userlevel']) && ($_SESSION['userlevel'] == 8)) ||(in_array('Great Plains', $_SESSION['sel_region']))){ ?>
