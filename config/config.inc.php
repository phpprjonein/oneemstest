...
$config_web_basedir = $_SERVER['DOCUMENT_ROOT'] . "/new_ems2/";

$config_app_basedir = $_SERVER['DOCUMENT_ROOT'] . "/new_ems2/" ;

/* DEFINES Below*/
define('WEB_DIR', $_SERVER['DOCUMENT_ROOT'] . "/new_ems2/");
