			...
			<div class="content">
				...
				<div class="modal fade" id="configtemplusrvalModal">
					<div class="modal-dialog">
						<div class="modal-content" id="configtemplusrvalModalContent">
							...
							<!-- Modal body -->
							<div class="modal-body">Configuration user variables saved
								successfully.</div>
							<!-- Modal body -->
              ...
              <!--<form action="software/html/tags/html_form_tag_action.cfm">-->
									...
									<div class="form-group">
										<label for="usrvarname">Variable name</label> <input
											type="text" class="form-control" id="usrvarname"
											placeholder="Enter Variable name">
									</div>
									<div class="form-group">
										<label for="usrvarval">Variable value </label> <input
											type="text" class="form-control" id="usrvarval"
											placeholder="Variable value">
									</div>

									<div class="form-group">
										<label for="deviceseries">Device Series </label> <input
											type="text" class="form-control" id="deviceseries"
											placeholder="Device Series">
									</div>

									<div class="form-group">
										<label for="templname">Template Name </label> <input
											type="text" class="form-control" id="templname"
											placeholder="Template Name">
									</div>
									<button type="button" value="SUBMIT" class="btn text-center"
										id="configtemplusrvar_submit" name="configtemplusrvar_submit">Submit</button>
