...
<!-- missed table content -->
			<div class="tab-pane fade table-responsive <?php if((isset($_SESSION['disc_page_tab']) && $_SESSION['disc_page_tab'] == 'Missed') || empty($_SESSION['disc_page_tab'])):?>show active<?php unset($_SESSION['disc_page_tab']); endif;?>" id="v-pills-missed" role="tabpanel" aria-labelledby="v-pills-missed-tab">
...
<!-- new table content -->
            <div class="tab-pane fade table-responsive <?php if(isset($_SESSION['disc_page_tab']) && $_SESSION['disc_page_tab'] == 'New'):?>show active<?php unset($_SESSION['disc_page_tab']); endif;?>" id="v-pills-new" role="tabpanel" aria-labelledby="v-pills-new-tab">
...
<!-- ok table content -->
            <div class="tab-pane fade table-responsive <?php if(isset($_SESSION['disc_page_tab']) && $_SESSION['disc_page_tab'] == 'OK'):?>show active<?php unset($_SESSION['disc_page_tab']); endif;?>" id="v-pills-ok" role="tabpanel" aria-labelledby="v-pills-ok-tab">
