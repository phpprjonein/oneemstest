						...
						<form id="usrmyfavlstfrm" name="usrmyfavlstfrm"
							...
							<div class="input-group add-on">
								<input name="addlist" id="addlist"
									...
									placeholder="Create New List" type="text"> <span
									class="input-group-btn">
									<button class="btn btn-default search-details" type="submit"
										name="addlistbtn" name="addlistbtn" value="Submit">Submit</button>
								</span>
							</div>
						</form>
						<br>
							...
							<div
								...
								<div>
									<span id="myswitchlist_delete" type="button"
										class="droppable box box-danger btn"> <i class="fa fa-trash"></i>&nbsp;
										<b>Drag Here To<br>DELETE
									</b>
									</span>
								</div>
							</div>
                ...
                foreach ($myswitchlist['result'] as $key => $value) {
                    ...
                    <tr style='cursor: pointer'
                      ...
                      <?php echo ($value['listname'] == '0' ? 'My Routers' : $value['listname']); ?>
											...
											<td>&nbsp;<a
												href="cellsitetech-user-devicelist.php?userid=<?php echo $userid;?>&listid=<?php echo $value['listid'];?>"><i
													class="fa fa-eye" width="20" height="22"></i></a>
											</td>
										</tr>
                  <?php
                }
							...
							<div
								...
								<div>
									...
									<span type="button"
										...
										class="fa fa-trash"></i>&nbsp;<b>Drag Here To<br>DELETE
									</b> </span> <span type="button"
										class="box box-danger border btn btn-edit-list-delete"
