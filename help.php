...
<!-- help guide -->
      <div class="col-md-9 col-sm-12 scrollspy-example" data-spy="scroll" data-target="#navbar-help" data-offset="0">
        ...
        <p class="border"><b class="text-danger">NOTE:</b> The following table shows the browsers and operating systems that this application supports. Using browsers besides the listed ones below will produce unintended results in terms of layout and/or functionality (supported versions of browsers in parenthesis).
        <br>
        <br>
        Please contact your system administrator or other supervisory body in order to assure that whatever device you are using this application on is equipped with any of the supported browser/OS combinations listed below.</p>
...
<!-- /browser/OS support table -->
        ...
        <p>Once this realtime health check is done, you will be able to click on the search icons <samp>{insert search page icon image here}</samp> associated with each parameter to view output directly from the console of the currently selected device.</p>
          ...
          <div id="accordion">
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                  ...
                  <ul>
                    <li>obtained permission / access from supervisor (or from CARMS when available)</li>
                    <li>must have a single sign on account in QTWIN and USWIN</li>
                  </ul>
            ...
            <div class="card">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                <div class="card-body">
                  <p>The <b><a href="#item-2">Network Elements</a> Dasboard</b></p>
                </div>
              </div>
            </div>
            <div class="card">
