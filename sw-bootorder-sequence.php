...
<script
	src="resources/js/swd_bootorder_batch_page.js?t=<?php echo date('his'); ?>"></script>
</head>
<body>
	<script>
    $(function() {
			...
			<section class="content">
				<div class="col-md-12">
                        ...
                        <?php foreach ($swrepolist as $key => $val){ ?>
        				        ...
        				        <?php }; ?>
									...
									<div class="form-group f8 required" data-fid="f8">
										...
										<select class="form-control custom-select chosen-select"
											multiple id="swrp_filename" name="swrp_filename"
                  ...
                  <div class="form-group f9 required" data-fid="f9">
										<label class="control-label" for="f9">Priority</label> <select
											class="form-control custom-select" id="sw_selpriority"
											name="sw_selpriority">
											<option>1</option>
											<option>2</option>
											<option>3</option>
