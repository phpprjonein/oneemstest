							...
							<div class="col-sm-12 col-md-4">
								<div class="jf-form">
                                    ...
                                    <?php $os_repository_vendor = os_repository_vendor(); ?>
                                        <div
										class="form-group f1 required" data-fid="f4">
										<label class="control-label" for="f1">Select Vendor</label> <select
											...
											<option value="">- SELECT Vendor -</option>
                                                ...
                                                <option
												value="<?php echo $val['vendorname'];?>"><?php echo $val['vendorname'];?></option>
                                                <?php }; ?>
                                            </select>
									</div>
									<!-- /select purpose options -->
...
select device series options -->
                        			...
                        			<?php $os_repository_deviceseries = os_repository_deviceseries();?>
                                        <div
										class="form-group f2 required" data-fid="f2">
