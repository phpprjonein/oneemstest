			...
			<div class="col-11 col-md-10">
				...
				<div class="tab-content" id="v-pills-tabContent">
					...
					<div
						...
						<table class="table table-sm table-striped ipcase1"
							...
							<tbody>
                <?php
                $resultset = load_tab_content_cellsite('ipcase1');
                if (isset($resultset)) {
                ...
                ?>
					...
					<div
						...
						<table class="table table-striped ip-new-table" id="ipcase2-table">
							...
							<tbody>
                <?php
                $resultset = load_tab_content_cellsite('ipcase2');
                if (isset($resultset)) {
                    foreach ($resultset as $key1 => $value1) {
                            foreach ($value1 as $key => $value) {    
                            ?>
              ...
              <table id="ipcase3-table"
				...
				<thead>
							...
							<tbody>
                <?php
                $resultset = load_tab_content_cellsite('ipcase3');
                if (isset($resultset)) {
                    foreach ($resultset as $key1 => $value1) {
                            foreach ($value1 as $key => $value) {    
                            ?>
...
<thead>
							...
							<tbody>
                <?php
                $resultset = load_tab_content_cellsite('ipcase4');
                if (isset($resultset)) {
                    foreach ($resultset as $key1 => $value1) {
                            foreach ($value1 as $key => $value) {    
                            ?>
...
<thead>
							...
							<tbody>
                <?php
                $resultset = load_tab_content_cellsite('ipcase5');
                if (isset($resultset)) {
