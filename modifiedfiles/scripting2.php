...
<div class="form-group">
  <span class="form-non-editable-fields">
    <label class="readonly">ip domain name verizonwireless.com</label>
    <input style="display:none !important;" size="36" name="loop[looper_89][]" value="ip domain name verizonwireless.com" class="form-control cellsitech-configtxtdisp" type="text">
