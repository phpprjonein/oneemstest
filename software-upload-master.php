				...
				<div class="col-md-12">
                  ...
                  <?php $swrepo_get_osversion = swrepo_get_osversion(); ?>
                    <div class="form-group f1 required" data-fid="f1">
										...
										<select id="dsosversion" name="dsosversion"
                          ...
                          <?php }; ?>
									...
									<div class="form-group f2 required" data-fid="f2">
										<label class="control-label" for="f2">Device Series</label> <input
											class="form-control inline" id="dsdeviceseries"
											type="deviceSeries" value=""
											placeholder="Enter Device Series">
									</div>
									<!-- /select device series options -->

									<input name="deviceSeries" id="deviceseriessubmit"
										class="btn config-submit" value="add" type="submit">
							...
							<div class="col-sm-12 col-md-6" id="rsform"
								...
								<div class="jf-form">
									...
									<div class="form-group f3 required" data-fid="f3">
										<label class="control-label" for="f3">OS Version</label> <input
											class="form-control inline" id="osversion" name="osversion"
											type="" placeholder="Enter OS Version">
									</div>
									<!-- select OS Version options -->

									<!-- select RAN Vendor options -->
									<div class="form-group f4 required" data-fid="f4">
										<label class="control-label" for="f4">Vendor Name</label> <input
											class="form-control inline" id="vendorname" name="vendorname"
											type="" placeholder="Enter Vendor Name">
									</div>
									<!-- /select RAN Vendor options -->

									<!-- select OS Patch options -->
									<div class="form-group f5 required" data-fid="f5">
										<label class="control-label" for="f5">Select Patch</label> <select
											class="form-control custom-select" id="ospatch"
											name="ospatch" data-rule-required="true">
									...
									<div class="form-group f7 required" data-fid="f7">
										...
										<input class="form-control inline" id="minverreq" type=""
											placeholder="Enter Minimum OS Version">
									</div>
									<!-- select Minimum OS Version options -->
									...
									<div class="form-group f8 required">
										<p>
											<b>Activate By Date: <input type="text" id="datepicker"
												placeholder="Apply date" class="form-control applydate"></b>
										</p>
									</div>
									<!-- activate by date -->
									...
									<div class="form-check form-check-inline">
										...
										<br> <input class="form-check-input" type="radio"
											name="inlineRadioOptions" checked="checked" id="inlineRadio1"
											value="y"> <label class="form-check-label" for="inlineRadio1">Yes</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="inlineRadioOptions" id="inlineRadio2" value="n"> <label
											class="form-check-label" for="inlineRadio2">No</label>
									</div>
									<!-- retired? -->

									<br> <input name="OSVersion" class="btn configsubmit"
										id="osversubmit" value="add" type="submit">
