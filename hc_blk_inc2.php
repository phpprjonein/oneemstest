...
echo $display; ?>
</td>										<td><input type="checkbox" id="mplsinterfaces" name="mplsinterfaces" value="12" <?php if(in_array(12, $_GET['category'])):?> checked="checked" <?php endif;?>></td>
...
echo $display; ?>
</td>																					  <td><input type="checkbox" id="mplsneighbors" name="mplsneighbors" value="11" <?php if(in_array(11, $_GET['category'])):?> checked="checked" <?php endif;?>></td>
