			...
			<div class="row">
				<div class="col-12 col-sm-12">
					...
					<form class="login-form" action="index.php" method="post">
						<input type="hidden" value="imp" name="userimp" /> <input
							type="hidden" value="<?php echo $_SESSION['username']; ?>"
							name="impusername" />

						<div class="input-group row">
							<div class="form-inline col-md-6 col-sm-12">
								<input type="inputName" name="username" class="form-control"
									id="inputName" placeholder="User Name" autofocus>
								<button type="submit" class="btn" id="manual-discovery"
