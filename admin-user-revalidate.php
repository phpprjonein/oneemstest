...
<div class="row">
  <div class="col-12 col-sm-12">
		  ...
		  <?php }  ?>
          <form class="login-form login-revalidate" action="admin-user-revalidate.php?redirect=os-repository.php" method="post">
              <div class="input-group row" >
                <div class="form-inline col-md-6 col-sm-12">
                  <input type="password" name="password" class="form-control" id="inputPassword" placeholder="Password">
                  <button type="submit" name="submit" value="Password Validate" class="btn" id="password-revalidate" data-toggle="modal">Submit</button>
                </div>
              </div>
          </form>
