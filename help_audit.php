...
<!-- audit guide -->
						<div class="col-md-9 col-sm-12 scrollspy-example"
                            ...
                            <p></p>
							<p>A user can filter the table results using the form fields for <b>Section Header</b>, a specific <b>Configuration Section</b> of a particular log file, and can also choose to ignore certain configuration lines in the results.</p>
                            ...
                            <img src="resources/img/screenshot-audit4-1.png" class="img-fluid" alt="" data-toggle="modal" data-target="#screenshot-audit4-1">
                            <p></p>
                            <span class="font-italic"><b>FIG. 9.3 - Customized Audit Dashboard</b></span>
                            <p></p>
                            ...
                            <p></p>
                            <span class="font-italic"><b>FIG. 9.3.1 - Custom Audit Batch Tracking Dashboard</b></span>
                            <p></p>
                            ...
                            <p></p>
                            <span class="font-italic"><b>FIG. 9.4 - Customized Audit History Dashboard</b></span>
                            <hr>
                            <div class="row">
								<div class="col-6">
