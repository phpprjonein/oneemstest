		...
		<tbody>
			<tr>
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_redundancy&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_process_cpu&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_version_rsp&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_version_installed_active&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_version_installed_committed&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><b>Alarms</b></td>
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_alarms&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_power_supply&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_fabric_status&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_fabric_inter_asic_drops&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_fabric_inter_asic_errors&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_fabric_inter_asic_link_status&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_up_down_status&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
...
$display = $display1.$display2;
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_count_interfaces&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><b>VRRP</b></td>
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_vrrp&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><b>NTP</b></td>
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_ntp&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_global_ospf_neighbor&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_1xrtt_ospf_neighbor&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_cell_mgmt_ospf_neighbor&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_ospf_nsr_gr&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_ldp_neighbor&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_wdn_peering&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_csr_peering&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_crs_wdn_peering&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_crs_lte_peering&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
		    ...
		    $display = $display1.$display2;
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_bgp_nsr_graceful_restart&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
				...
				<td><a id="anchorcmd" class="anchorcmd"
					href="healthchk-asrfivefivezeroone-devdetmdl-cellsite.php?commandname=extract_air_filter_check&deviceid=<?php echo $_SESSION['deviceidswusr'];?>&deviceseries=<?php echo $_GET['deviceseries']?>&version=<?php echo $_GET['version']?>"><i
						class="fa fa-file-text-o fa-lg text-primary"></i></a><?php
