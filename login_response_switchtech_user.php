...
?>
<?php
// curl -k -d "grant_type=password&username=xxxxx&password=xxxxx" -H "Authorization: Basic ZkFqd1lDSnpvdDRpRdjhh" https://nssapigateway.vh.vzwnet.com/token
$token_url = 'https://nssapigateway.vh.vzwnet.com/token?grant_type=password&username=xxxxx&password=xxxxx';
...
// curl_setopt($ch, CURLOPT_USERPWD, "xxxxx:xxxxx");
$data = array(
    "grant_type" => 'password',
    'username' => 'xxxxx',
    'password' => 'xxxxx'
