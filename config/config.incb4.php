...
$config_web_basedir = $_SERVER['DOCUMENT_ROOT'] . "/oneems/";

$config_app_basedir = $_SERVER['DOCUMENT_ROOT'] . "/oneems/" ;

/* DEFINES Below*/
define('WEB_DIR', $_SERVER['DOCUMENT_ROOT'] . "/oneems/");
...
define('DB_HOST', '63.49.0.193');
define('DB_PORT', '3306');
define('DB_NAME', 'oneems');
define('DB_USER', 'keshav');
define('DB_PASSWORD','keshav');
