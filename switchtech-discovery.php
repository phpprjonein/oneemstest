...
<head>
   ...
   <script
	src="resources/js/switchtech_discovery.js?t=<?php echo date('his'); ?>"></script>
</head>
<body>
	<!-- container div -->
		...
		<div class="row">
			...
			-->
					<a
						...
						id="v-pills-missed-tab" data-toggle="pill" href="#v-pills-missed"
						role="tab" aria-controls="v-pills-missed" aria-selected="false">Missed</a>
					<a
						class="nav-link btn-new <?php if(isset($_SESSION['disc_page_tab']) && $_SESSION['disc_page_tab'] == 'New'):?>active<?php endif;?>"
						id="v-pills-new-tab" data-toggle="pill" href="#v-pills-new"
						role="tab" aria-controls="v-pills-new" aria-selected="false">New</a>
					<a
...
conflict table content -->
					...
					<div
						class="tab-pane fade <?php if((isset($_SESSION['disc_page_tab']) && $_SESSION['disc_page_tab'] == 'Missed') || empty($_SESSION['disc_page_tab'])):?>show active<?php unset($_SESSION['disc_page_tab']); endif;?>"
						id="v-pills-missed" role="tabpanel"
						aria-labelledby="v-pills-missed-tab">
						<table class="table table-sm table-striped ip-missed-table"
							...
							<thead>
								<tr>
									...
									<th scope="col">OS Version</th>
									<th scope="col">Last Polled</th>
									<th scope="col" style="display: none;">Remove / Update</th>
									<th scope="col" style="display: none;">Region</th>
									<th scope="col" style="display: none;">Market</th>
								</tr>
							</thead>
                ...
                ?>
					...
					<!-- new table content -->
					<div
						class="tab-pane fade <?php if(isset($_SESSION['disc_page_tab']) && $_SESSION['disc_page_tab'] == 'New'):?>show active<?php unset($_SESSION['disc_page_tab']); endif;?>"
						id="v-pills-new" role="tabpanel" aria-labelledby="v-pills-new-tab">
                ...
                ?>
					...
					<!-- ok table content -->
					<div
						class="tab-pane fade <?php if(isset($_SESSION['disc_page_tab']) && $_SESSION['disc_page_tab'] == 'OK'):?>show active<?php unset($_SESSION['disc_page_tab']); endif;?>"
              ...
              <table id="ip-ok-table"
                    ...
                    <th scope="col" style="display: none;"><a href="#"
										id="select_all" onclick="ok_all_item();"
										style="display: none;">Select&nbsp;All</a></th>
                    <?php else:?>
								...
								<div class="col-auto field">
									<div class="form-group form-inline">
										<label class="control-label mr-2" for="inputDeviceIPaddress">Device
											...
											class="form-control inline" id="inputDeviceIPaddress">
									</div>
								</div>
...
<!-- Missed Modal -->
	...
	<div id="Modal_Missed_Update" tabindex="-1" class="modal fade"
		...
		<div class="modal-dialog modal-lg" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div id="status" style="display: none;" class="alert"></div>
					<div id="ajax_loader" style="padding-left: 45%;">
						<img src="resources/img/ajax-loader.gif" style="display: none;"></img>
					</div>
					<div class="row" id="discovery-missed-ip" style="display: none;">
						<div class="col-auto">
							<div class="form-check mb-2 mb-sm-0">
								...
								<div class="btn-group" id="button-action" role="group"
									aria-label="">
									<input type="hidden" value="" name="missedDeviceIPaddress"
										id="missedDeviceIPaddress" />
									<button type="button" class="btn btn-primary" value="OK"
										id="ip-ok">OK</button>
									&nbsp;&nbsp;&nbsp;
									<button type="button" class="btn btn-primary" value="Ignore"
										id="ip-ignore">Ignore</button>
									&nbsp;&nbsp;&nbsp;
									<button type="button" class="btn btn-primary" value="Remove"
										id="ip-remove">Remove From Master</button>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form>
						<div class="row">
							...
							<div class="col-lg-6 col-md-12 border">
								...
								<div class="row">
									<div class="col-md-6">
										<label for="inputRegion">Region</label> <input
											type="regionName" class="form-control-plaintext"
											id="inputRegion" placeholder="Ohio" readonly>
									</div>
									<div class="col-md-6">
										<label for="inputMarket">Market</label> <input
											type="marketnName" class="form-control-plaintext"
											id="inputMarket" placeholder="OPW" readonly>
									</div>
								</div>
								<!-- /first row -->
								<!-- /first section -->
								...
								<div class="row">
									<div class="col-md-6">
										<label for="inputDevicename">Device Name</label> <input
											type="deviceName" class="form-control-plaintext"
											id="inputDevicename" placeholder="MSHWINBWT1A-P-CI-0090-01"
											readonly>
									</div>
									<div class="col-md-6">
										<label for="inputDeviceIPaddress">Device IP Address</label> <input
											type="deviceIPaddress" class="form-control-plaintext"
											id="inputDeviceIPaddress" readonly>
									</div>
								</div>
								<!-- /second row -->
								...
								<div class="row">
									<div class="col-md-12">
										<label for="inputNodeAddedBy">Node Added By</label> <input
											type="NodeAddedBy" class="form-control-plaintext"
											id="inputNodeAddedBy"
											value="<?php echo $_SESSION['username'];?>"
											placeholder="userID of Discovery Mgr" readonly>
									</div>
								</div>
								<!-- /third row -->
								...
								<div class="row">
									<div class="col-md-6">
										<label for="inputNodeCatID">Node Category</label> <input
											type="NodeCatID" class="form-control-plaintext"
											id="inputNodeCatID" placeholder="Router" readonly>
									</div>
									<div class="col-md-6">
										<label for="inputVendorID">Vendor</label> <input type="model"
											class="form-control-plaintext" id="inputVendorID"
											placeholder="CISCO" readonly>
									</div>
								</div>
								<!-- /fourth row -->
								...
								<div class="row">
									<div class="col-md-12">
										<label for="inputDeviceSeries">Device Series</label> <input
											type="model" class="form-control-plaintext"
											id="inputDeviceSeries" placeholder="ASR900" readonly>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<label for="inputNodeVersion">OS</label> <input
											type="nodeVersion" class="form-control-plaintext"
											id="inputNodeVersion" placeholder="IOS-XE" readonly>
									</div>
									<div class="col-md-6">
										<label for="inputDeviceStatus">Status</label> <input
											type="deviceStatus" class="form-control-plaintext"
											id="inputDeviceStatus" value="Operational"
											placeholder="Operational" readonly>
									</div>
								</div>
								<!-- /fifth row -->
								<!-- /second section -->
								...
								<div class="row">
									<div class="form-group col-md-6">
										<label for="inputCSRSiteTechName">Tech Name</label> <input
											type="CSRSiteTechName" class="form-control-plaintext"
											id="inputCSRSiteTechName" placeholder="Site Tech Name"
											readonly>
									</div>
									<div class="form-group col-md-6">
										<label for="inputCSRSiteTechMgrName">Tech Mgr Name</label> <input
											type="CSRSiteTechMgrName" class="form-control-plaintext"
											id="inputCSRSiteTechMgrName" placeholder="Site Tech Mgr Name"
											readonly>
									</div>
								</div>
								<!-- /sixth row -->
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label for="inputCSRSiteID">Site Name</label> <input
											type="CSRSiteID" class="form-control-plaintext"
											id="inputCSRSiteID" placeholder="Site Name" readonly>
									</div>
								</div>
								<!-- /seventh row -->
								...
								<div class="row">
									<div class="form-group col-md-6">
										<label for="inputDeviceDateAdded">Device Date Added</label> <input
											type="lastPolled" class="form-control-plaintext"
											id="inputDeviceDateAdded"
											value="<?php echo date('m/d/y'); ?>" placeholder="Today()"
											readonly>
									</div>
									<div class="form-group col-md-6">
										<label for="inputDeviceLastUpdated">Device Last Updated</label>
										<input type="upSince" class="form-control-plaintext"
											id="inputDeviceLastUpdated"
											value="<?php echo date('m/d/y H:i:s'); ?>"
											placeholder="dateTimeStamp of Discovery" readonly>
									</div>
								</div>
								<!-- /eighth row -->
								...
								<div class="row">
									<div class="form-group col-md-6">
										<label for="inputLastPolled">Last Polled</label> <input
											type="lastPolled" class="form-control-plaintext"
											id="inputLastPolled" placeholder="11/16/17 19:28" readonly>
									</div>
									<div class="form-group col-md-6">
										<label for="inputUpSince">Up Since</label> <input
											type="upSince" class="form-control-plaintext"
											id="inputUpSince" readonly>
									</div>
					...
					-->
									<div class="form-group col-md-4">
										<label for="inputDeviceOS">Device OS</label> <input
											type="deviceOS" class="form-control-plaintext"
											id="inputDeviceOS" placeholder="auto derive from osypeTable"
											readonly>
									</div>
								</div>
								<!-- /tenth row -->
							...
							<div class="col-lg-6 col-md-12 border">
								...
								<div class="row">
									<div class="form-group col-md-6">
										<label for="inputCSRSiteTechNameID">Tech Name</label> <input
											type="inputCSRSiteTechNameID" class="form-control"
											id="inputCSRSiteTechNameID" placeholder="Site Tech Name"> <input
											type="hidden" value="" name="inputCSRSiteTechNameIDVal"
											id="inputCSRSiteTechNameIDVal">
									</div>
									<div class="form-group col-md-6">
										<label for="inputCSRSiteTechMgrNameID">Tech Mgr Name</label> <input
											type="inputCSRSiteTechMgrNameID"
											class="form-control-plaintext" id="inputCSRSiteTechMgrNameID"
											placeholder="Site Tech Mgr Name" readonly> <input
											type="hidden" value="" name="inputCSRSiteTechMgrNameIDVal"
											id="inputCSRSiteTechMgrNameIDVal">
									</div>
								</div>
								<!-- /first row -->
								<!--  selector -->
								<div class="row">
									<div class="form-group col-md-6" id="tech-details">
										<label for="inputCSRTechID">Existing</label> <input
											type="radio" name="added-details" checked value="1" /> <label
											for="inputCSRTechID">New</label> <input type="radio"
											name="added-details" value="0" />
									</div>
								</div>
								<!-- second row -->
								<div class="row">
									...
									<div class="form-group col-md-6">
										<label for="inputCSRSiteName">Site Name</label> <input
											type="inputCSRSiteName" class="form-control site-name-exist"
											id="inputCSRSiteName" placeholder="Site Name"> <input
											type="inputCSRTechID" style="display: none;"
											class="form-control-plaintext site-name-new"
											id="inputCSRSiteNameNew" placeholder="Site Name">
									</div>
                      ...
                      <option
												value="<?php  echo $val['switch_name']; ?>"><?php  echo $val['switch_name']; ?></option>
                        <?php } ?>
                      </select>
									</div>
								</div>
								...
								<div class="row" id="discovery-new-ip">
									<div class="col-auto">
										<div class="form-check mb-2 mb-sm-0">
											<div class="btn-group" role="group" aria-label="">
												<button type="button" class="btn" value="Add New"
													id="add-new-ip">ADD NEW</button>
											</div>
										</div>
									</div>
								</div>
