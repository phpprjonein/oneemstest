					...
					<div class="form-group f8 required col-md-4" data-fid="f8">
						...
						<select data-placeholder="Select Template Names..."
							...
							foreach ($templates as $key=>$val):
								if(substr( $val['templname'], 0, 6 ) === "Golden"){?>
						...
						<div class="col-sm-12 col-md-12" id="listname-dd">
							<div class="row">
								<div class="col">
									...
									<table id="manageusrvars" class="display" style="width: 100%">
										<thead>
											<tr>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									...
									<div id="main-status" class="alert alert-success">
										Configuration Template Updated Successfully
									</div>
									<?php } unset($_SESSION['msg']); ?>
									<div class="row">
										...
										<div class="col-sm-12 col-md-8">
											...
											<div class="row">
												<div class="col">
													...
													<div id="file_process">
														<form name="file_process" action="cellsite-config-process.php" method="post">
