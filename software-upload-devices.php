...
<!-- Device Series multiselect -->
            <div class="form-group f10 required">
              <label for="f10" class="control-label">Choose a Device Series</label>
              <select data-placeholder="Choose a Device Series..." class="chosen-select form-control" multiple tabindex="4">
                <option value=""></option>
