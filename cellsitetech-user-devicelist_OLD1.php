...
<html>
 ...
 <script src="resources/js/cellsitetech_user_dash_devices.js?t=<?php echo date('his'); ?>"></script>
                  ...
                  <div class="col-md-12">
                      <div class="panel">
                          ...
                          <div class="panel-body">
                            <table id="example" class="display table-responsive" data-listid="<?php echo $listid ?>" cellspacing="0" width="100%">
                              <thead>
                                <tr>
