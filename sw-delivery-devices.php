...
select device series options -->
									...
									<div class="form-group f8 required" data-fid="f8">
										...
										<select data-placeholder="Choose a File Names..."
											class="form-control custom-select chosen-select" multiple
											id="swrp_filename" name="swrp_filename"
				...
				<!-- select device series options -->
									<div class="form-group f7 required" data-fid="f17">
										...
										<select id="destdrive" name="destdrive"
											class="form-control custom-select" data-rule-required="true">
