...
, $timestamp.'ASR903-02.script', $timestamp.'IXR-01.script', $timestamp.'IXR-02.script', $timestamp.'IXR-03.script');
    ...
    if ($_FILES["file"]["type"] == "text/plain") {
        ...
        if (file_exists("/usr/apps/oneems/fs1/upload/sampleconfigfile_" . $_SESSION['userid'] . ".txt")) {
            //unlink("/usr/apps/oneems/fs1/sampleconfigfile_" . $_SESSION['userid'] . ".txt");
            unlink("/usr/apps/oneems/fs1/upload/sampleconfigfile_" . $_SESSION['userid'] . ".txt");
        }
