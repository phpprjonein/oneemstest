...
<!-- help guide -->
      <div class="col-md-9 col-sm-12 scrollspy-example" data-spy="scroll" data-target="#navbar-help" data-offset="0">
        ...
        <p>In order to add devices to your list, first open a list for editing. To do this, click on the <b>Edit</b> icon ( <i class="fas fa-edit text-primary"></i> ) to the immediate right of the list name. The contents of the selected list will appear in the center column of the page.</p>
        <p>Next, select a Region and subsequent Market from the map. this will display the devices associated with these areas.</p>
        <p>You can then drag and drop using the drag icon ( <i class="fas fa-expand-arrows-alt"></i> ) to bring any selected devices into the <b>Edit List</b> section column on the immediate left of the map Region. This will add these devices to your list and make them available for management in various areas of the application.</p>
        <b>Deleting A Device From Your Custom List</b>
        <p>To remove a device from your created list, simply use the drag icon to drag and drop it over the trash icon ( <i class="fas fa-trash-alt text"></i> ) inside the <b>Delete</b> button. Once you confirm this action, this will remove this device from the list. You may add it again by repeating the process of dragging it into the <b>Edit List</b> area from the list of devices under the map.</p>
        ...
        <p class="border"><b class="text-danger">NOTE:</b> Cell Site Technicians will be provided a <b>"My Routers"</b> List. This List contains Routers that are assigned to the Cell Site Technician via <b>Ops Tracker</b>.</p>
        ...
        <p>To view the health of a specific device, click on the plus icon ( <i class="fas fa-plus-circle text-primary"></i> ) on the leftmost column of the device. This will run a script that will run a realtime health check on the device in view.</p>
        <p class="border"><b class="text-danger">NOTE:</b> Upon initialization, 21 separate Health Checks will run in series on the chosen Router. This process can take up to one minute to complete.</p>
        ...
        <p></p>
        <p>Once this realtime health check is done, you will be able to click on the page icons ( <i class="far fa-file-alt text-primary"></i> ) associated with each parameter to view output directly from the console of the currently selected device.</p>
