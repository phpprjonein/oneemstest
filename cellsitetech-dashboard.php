...
<script src="resources/js/cellsitetech_user_list.js?t=<?php echo date('his'); ?>"></script>
</head>
<body>
                ...
                <?php
                  ...
                  ?>
                    <tr style='cursor:pointer' class="del_<?php echo $value['listid'];?>">
                      ...
                      <a href="cellsitetech-user-devicelist.php?userid=<?php echo $userid;?>&listid=<?php echo $value['listid'];?>"><?php echo ($value['listname'] == '0' ? 'My Routers' : $value['listname']); ?></a>
                      </td>
          ...
          <div class="col-md-6 panel-warning panel-default" id="listedit-wrap">
            <div class="alert alert-secondary panel-heading-editlst text-center" id="mylist_delete">
              ...
              <div>
                ...
                <span type="button" class="box box-danger btn btn-edit-list-delete" style="cursor: pointer;" onclick="javascript:window.location.assign('cellsitetech-dashboard.php');" data-target="#listedit-wrap" data-dismiss="alert">close list<span aria-hidden="true"><b>&times;</b></span></span>
    ...
    <div id="rhsPanel" class="col-sm-6 col-md-6">
      <div class="maprow">
            ...
            <div id="map_section" class="sec_with_map border table-responsive" style='<?php echo ($show_map_flag) ? "display: block" : "display: none" ?>;'>
              <!-- US Map Image -->
              <img src="resources/img/map_new.png" id="map_image" usemap="#United States of America" height="50%">
              ...
              <map name="United States of America">
                ...
                <area name="Northern California/Nevada" shape="poly" coords="21,104,120,130,107,200,91,198,94,181,101,183,102,173,96,166,84,163,74,162,65,160,62,160,64,163,62,166,59,167,97,222,97,225,100,230,99,233,99,235,96,237,94,242,92,246,92,250,93,253,89,254,88,252,62,248,62,241,53,229,50,226,46,226,41,218,32,216,29,214,32,206,28,200,24,191,23,185,25,179,21,175,21,164,18,160,17,155,14,148,14,143,16,138,16,133,13,128,13,123,16,119,20,112" href="#" class="map_region" data-market="NorthernCalifornia"  alt="Northern California/Nevada" title="Northern California/Nevada" OnMouseOver="window.status='Northern California/Nevada'; return true" OnMouseOut="window.status=''; return true">

                <!-- Pacific Northwest/Alaska -->
                <area name="Pacific Northwest/Alaska" shape="poly" coords="102,348,104,293,91,293,81,290,74,283,64,287,49,292,51,299,55,309,47,305,40,306,43,313,51,316,53,322,45,324,37,328,35,338,40,342,42,345,42,350,50,350,53,353,46,362,32,368,16,371,44,367,61,359,74,353,84,348,91,351,104,354,112,359,117,366,132,380,138,372,131,366,120,354,114,353,108,354,102,349" href="#" class="map_region" data-market="PacificNorthwest"  alt="Pacific Northwest/Alaska" title="Pacific Northwest/Alaska" Onclick="test();"  OnMouseOver="window.status='Pacific Northwest/Alaska'; return true" OnMouseOut="window.status=''; return true">

                <!-- Pacific Northwest Hawaii -->
                <area name="Pacific Northwest Hawaii" shape="poly" coords="155,333,161,329,203,349,221,369,221,374,213,376,207,377,206,361,199,354,183,347,170,340,160,337,149,336,152,333,155,332,155,332" href="#" class="map_region" data-market="PacificNorthwest"  alt="Pacific Northwest Hawaii" title="Pacific Northwest Hawaii" OnMouseOver="window.status='Pacific Northwest Hawaii'; return true" OnMouseOut="window.status=''; return true">
      ...
      <div class="panel-info panel-default">
        <div class="alert alert-secondary panel-heading-swtname router_search_box">
          ...
          ?>
          <span id="map_show_link" class="pull-right sec_without_map" style='<?php echo ($show_map_flag) ? "display: none" : "display: block" ?>' onclick="showMap()"><b>Show Map</b>&nbsp;  <img width="25px" src="resources/img/usmap-icon.png" >&nbsp;</span>
          <span id="map_hide_link" class="pull-right sec_with_map" style='<?php echo ($show_map_flag) ? "display: block" : "display: none" ?>' onclick="hideMap()"><b>Hide Map</b>&nbsp;  <img width="25px" src="resources/img/usmap-icon.png" >&nbsp;</span>
        </div>
