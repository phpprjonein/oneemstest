...
<html>
   <?php include_once("includes.php");  ?>
				...
				<div class="col-md-12">
					<div class="box">
						<div class="box box-solid">
							...
							<div>
								<form class="navbar-form search" method="POST"
									action="cellsitetech-devicelist.php" role="search">
									<div class="input-group add-on">
										<input class="form-control" placeholder="Search"
											name="search_term" id="srch-term" type="text">
										<div class="input-group-btn">
											<button class="btn btn-default" type="submit">
												<i class="glyphicon glyphicon-search" style="color: #D52B1E"></i>
											</button>
										</div>
									</div>
                            <?php
                            if ($_SESSION['search_term']) {
                                ?>
                              <a type="button"
										class="btn bg-purple btn-flat margin" title="Cleasr Search"
										href="cellsitetech-devicelist.php?clear=search"> <?php echo $_SESSION['search_term'] ?> <i
                            ...
                            <div class="box-group" id="accordion">
                              ...
                              <!-- Table Records section -->
									<div class="panel"  style="border: 1px solid  <?php echo ($k%2==0) ? '#fcfcfc':'#f6f6f6' ?>; margin-bottom: 2px;">
										<table style=" <?php echo ($k%2==0) ? 'background-color: #fcfcfc':'background-color:#ffffff'; ?>" class="table device_details collapsed"  data-userid="<?php echo $userid; ?>"  data-deviceid="<?php echo $device['id']; ?>" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $k+1 ?>">
											...
											<tbody>
												<tr>
													...
													<td>Up Since <?php echo date('m/d/Y', strtotime($device['upsince'])); ?>
										...
										<div id="collapse<?php echo $k+1; ?>"
											class="mydevicebox_<?php echo $device['id']; ?> panel-collapse collapse">
                            ...
                            <?php
                                ...
                                ?>
                            <div class="panel center">No Records found</div>
                            <?php
                            }
                            ?>
                          </div>
	...
	<!-- ./wrapper -->
        ...
        <script src="resources/js/devices.js?t="
